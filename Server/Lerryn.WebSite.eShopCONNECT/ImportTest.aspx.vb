...
Partial Class ImportTest
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            eShopCONNECTFacade = New Lerryn.Facade.ImportExport.ImportExportConfigFacade(eShopCONNECTDatasetGateway, New Lerryn.Facade.ImportExport.ErrorNotification, PRODUCT_CODE, PRODUCT_NAME) ' TJS 11/02/09 TJS 18/03/11 TJS 10/06/12
